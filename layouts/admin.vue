         ...
         <div class="lg:pl-60">
             ...
             <main class="py-5">
                 <div class="px-4 sm:px-6 ">
                     ...
                     <!-- Borrowers Section -->
                  <div class="mt-8">
                    <h4 class="text-xl font-bold text-gray-700">BORROWERS</h4>
                    <div class="flex mt-2">
                    ...
                    <div class="flex flex-wrap -mx-6 mt-4">
                      <DashboardCard title="New Borrowers" value="0" />
                      <DashboardCard title="Old Borrowers" value="0" />
                      <DashboardCard title="Borrower Status" value="Active or Not" />
                      <DashboardCard title="Total Borrowers" value="0" />
                    </div>
                  </div>
  
                  <!-- Collections and Disbursement Section -->
                  <div class="mt-8">
                    <h4 class="text-xl font-bold text-gray-700">COLLECTIONS AND DISBURSEMENT</h4>
                    <div class="flex mt-2">
                      <select class="mr-2 p-2 border rounded">
                        <option>MONTH</option>
                      </select>
                    ...
                    <div class="flex flex-wrap -mx-6 mt-4">
                      <DashboardCard title="Collected" value="0" />
                      <DashboardCard title="Disbursement" value="0" />
                      <DashboardCard title="Fully Paid" value="0" />
                      <DashboardCard title="Partially Paid" value="0" />
                    </div>
                  </div>
  
                  <!-- Groups Section -->
                  <div class="mt-8">
                    <h4 class="text-xl font-bold text-gray-700">GROUPS</h4>
                    <div class="flex mt-2">
                      <select class="mr-2 p-2 border rounded">
                        <option>MONTH</option>
                      </select>
                    ...
                    <div class="flex flex-wrap -mx-6 mt-4">
                      <DashboardCard title="Number of Groups" value="0" />
                      <DashboardCard title="New Groups" value="0" />
                      <DashboardCard title="Old Groups" value="0" />
                      <DashboardCard title="Group Status" value="Active or Not" />
                    </div>
                  </div>
  
                  <!-- Warned Borrowers -->
                  <div class="mt-8">
                    <h4 class="text-xl font-bold text-gray-700">WARNED BORROWERS</h4>
                    <div class="flex mt-2">
                      <select class="mr-2 p-2 border rounded">
                        <option>MONTH</option>
                      </select>
  ...
  const navigation = [
     ...
     { name: "Admin Panel", icon: UsersIcon, current: false,
         children: [
             ...
             { name: "Staff Roles and Permissions", href: "/#", icon: UserIcon, current: false },
